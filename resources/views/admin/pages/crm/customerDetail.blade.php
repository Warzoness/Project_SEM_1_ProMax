                        ...
                        <div class="card-body">
                            <div class="flex flex-col xl:justify-between h-full 2xl:min-w-[360px] mx-auto">
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-1 gap-y-7 gap-x-4 mt-8">
                                    <div>
                                        <span>Email</span>
                                        <p class="text-gray-700 dark:text-gray-200 font-semibold">iamfred@imaze.infotech.io
                                        </p>
                                    </div>
                                    <div>
                                        <span>Phone</span>
                                        ...
                                        <div class="flex mt-4 gap-2">
                                            <button class="btn btn-default btn-icon btn-sm rounded-full">
                                                <svg stroke="currentColor" fill="currentColor" stroke-width="0"
                                                    viewBox="0 0 320 512" class="text-[#1773ea]" height="1em"
                                            ...
                                            <button class="btn btn-default btn-icon btn-sm rounded-full">
                                                <svg stroke="currentColor" fill="currentColor" stroke-width="0"
                                                    viewBox="0 0 512 512" class="text-[#1da1f3]" height="1em"
                                                    width="1em" xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                            ...
                                            <button class="btn btn-default btn-icon btn-sm rounded-full">
                                                <svg stroke="currentColor" fill="currentColor" stroke-width="0"
                                                    viewBox="0 0 448 512" class="text-[#0077b5]" height="1em"
                                                    width="1em" xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                            ...
                                            <button class="btn btn-default btn-icon btn-sm rounded-full">
                                                <svg stroke="currentColor" fill="currentColor" stroke-width="0"
                                                    viewBox="0 0 384 512" class="text-[#df0018]" height="1em"
                                                    width="1em" xmlns="http://www.w3.org/2000/svg">
                                                    <path
                    ...
                    <div class="w-full">
                                                ...
                                                <div class="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        <div class="flex items-center">
                                                            ...
                                                            <div
                                                                class="tag bg-emerald-100 text-emerald-600 dark:bg-emerald-500/20 dark:text-emerald-100 rounded-md border-0 mx-2">
                                                        ...
                                                        <div>
                                                            ...
                                                            <span>
                                                                ...
                                                                <span
                                                                    class="font-semibold text-gray-900 dark:text-gray-100">$59.90</span>
                                                            </span>
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <div>
                            ...
                            <div class="rounded-lg border border-gray-200 dark:border-gray-600">
                                <div
                                    class="flex flex-col lg:flex-row lg:items-center justify-between gap-3 p-4 border-b border-gray-200 dark:border-gray-600">
                                    <div class="flex items-center gap-3"><img src="img/others/img-8.png" alt="visa">
                                        <div>
                                            <div class="flex items-center">
                                                <div class="text-gray-900 dark:text-gray-100 font-semibold">Frederick Adams
                                                    •••• 0392</div>
                                                <div
                                                    class="tag bg-sky-100 text-sky-600 dark:bg-sky-500/20 dark:text-sky-100 rounded-md border-0 mx-2">
