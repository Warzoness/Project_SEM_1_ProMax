    ...
    <main class="h-full">
        <div class="page-container relative h-full flex flex-auto flex-col px-4 sm:px-6 md:px-8 py-4 sm:py-6">
            <div class="container mx-auto">
                ...
                <form action="{{ route('etproducts.update', $etproduct) }}" method="POST" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
                                ...
                                <div class="card adaptable-card !border-b pb-6 py-4 rounded-br-none rounded-bl-none">
                                    <div class="card-body">
                                        ...
                                        <div class="form-item vertical">
                                            ...
                                            <div>
                                                <input class="input" type="text" name="name" autocomplete="off"
                                                    value="{{ $etproduct->name }}" id="title" onkeyup="ChangeToSlug()">
                                            </div>
                                            @error('name')
                                        ...
                                        <input class="input" type="text" name="slug" id="slug"
                                            autocomplete="off" value="{{ $etproduct->slug }}" placeholder="" hidden>
                                                                ...
                                                                <div>
                                                                    <span class="input-wrapper undefined">
                                                                        <input class="input" type="text" name="type"
                                                                            autocomplete="off"
                                                                            placeholder="Nhập vào kiểu loại"
                                                                            value="{{ $etproduct->type }}"
                                                                            inputmode="numeric">
                                                                    </span>
                                                                </div>
                                                                @error('type')
                                                    ...
                                                    <div>
                                                        <span class="input-wrapper undefined">
                                                            ...
                                                            <input class="input pl-8" type="text" name="price"
                                                                ...
                                                                value="{{ $etproduct->price }}" inputmode="numeric">
                                                        </span>
                                                    </div>
                                                    @error('price')
                                                        <div class="alert alert-dismissible fade show alert-danger">
                                                    ...
                                                    <div>
                                                        <span class="input-wrapper undefined">
                                                            ...
                                                            <input class="input pl-8" type="text" name="sale_price"
                                                                ...
                                                                value="{{ $etproduct->sale_price }}" inputmode="numeric">
                                                        </span>
                                                    </div>
                                                    @error('sale_price')
                                                        <div class="alert alert-dismissible fade show alert-danger">
                                                    ...
                                                    <div>
                                                        <span class="input-wrapper undefined">
                                                            <input class="input" type="text" name="quantity"
                                                                ...
                                                                value="{{ $etproduct->quantity }}" inputmode="numeric">
                                                        </span>
                                                    </div>
                                                </div>
                                                @error('quantity')
                                                        ...
                                                        <select class="input js-example-basic-single" name="product_id">
                                                            @foreach ($products as $item)
                                                                <option value="{{ $item->id }}"
                                                                    {{ $etproduct->product_id == $item->id ? 'selected' : '' }}>
                                                                    {{ $item->name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                ...
                                                <div class="form-item vertical">
                                                    ...
                                                    <div>
                                                        <select class="input" name="tag">
                                                            <option value="1"
                                                                {{ $etproduct->tag == 1 ? 'checked' : '' }}>Mới</option>
                                                            <option value="0"
                                                                {{ $etproduct->tag == 0 ? 'checked' : '' }}>Hot</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="lg:col-span-1">
                                <div class="card adaptable-card mb-4">
                                    <div class="card-body">
                                        <h5>Ảnh Sản Phẩm</h5>
                                        <p class="mb-6">Thêm mới 1 hoặc nhiều ảnh cho sản phẩm</p>
...
@section('customJs')
    ...
    <!-- Page js -->
    <script src="{{ asset('assets') }}/js/pages/new-etproduct.js"></script>
