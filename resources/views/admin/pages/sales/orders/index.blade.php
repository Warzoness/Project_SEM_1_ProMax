                ...
                <div class="card adaptable-card">
                    <div class="card-body">
                        <div class="lg:flex items-center justify-between mb-4">
                            <h3 class="mb-4 lg:mb-0">Tất Cả Orders</h3>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="flex items-center">
                                                    @if ($item->tag == 1)
                                                        <span class="badge bg-blue-500 p-2"> Xác Nhận</span>
                                                    @elseif($item->tag == 0)
                                                        <span class="badge bg-emerald-500 p-2">Chờ Xác Nhận</span>
                                                    @else
                                                        <span class="badge p-2">Đã Hủy</span>
                                                    @endif
                                                </div>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="flex justify-end text-lg align-center items-center gap-3">
                                                    ...
                                                    <a href="{{ route('orders.detail', $item) }}">
