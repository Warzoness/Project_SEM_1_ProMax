                                    ...
                                    <div class="mt-3">
                                        ...
                                        <div class="flex items-center justify-between mt-2">
                                            <div class="avatar-group avatar-group-chained">
                                                ...
                                                <span class="avatar avatar-circle cursor-pointer avatar-sm bg-amber-500"
                            ...
                            <div class="card-body h-full">
                                <div class="flex flex-col justify-between h-full">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <div class="flex items-center justify-between mt-2">
                                            <div class="avatar-group avatar-group-chained">
                                                <span class="avatar avatar-circle cursor-pointer avatar-sm bg-violet-500"
                                ...
                                <div class="flex flex-col justify-between h-full">
                                    ...
                                    <div class="mt-3">
                                        <div class="progress line">
                                            <div class="progress-wrapper">
                                                <div class="progress-inner">
                                                    <div class="progress-bg h-1.5 bg-indigo-600" style="width: 67%;">
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="card-body h-full">
                                <div class="flex flex-col justify-between h-full">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <div class="flex items-center justify-between mt-2">
                                            <div class="avatar-group avatar-group-chained">
                                                <span class="avatar avatar-circle cursor-pointer avatar-sm bg-pink-500"
                                                    data-bs-toggle="tooltip" data-bs-title="Debra Hamilton">
                                                    <span class="avatar-string avatar-circle">LC</span>
                                                </span>
                                                <span class="avatar avatar-circle cursor-pointer avatar-sm bg-blue-600"
                                ...
                                <div class="flex flex-col justify-between h-full">
                                    ...
                                    <div class="mt-3">
                                        <div class="progress line">
                                            <div class="progress-wrapper">
                                                <div class="progress-inner">
                                                    <div class="progress-bg h-1.5 bg-indigo-600" style="width: 50%;">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="flex items-center justify-between mt-2">
                                            <div class="avatar-group avatar-group-chained">
                                                ...
                                                <span class="avatar avatar-circle cursor-pointer avatar-sm bg-fuchsia-500"
