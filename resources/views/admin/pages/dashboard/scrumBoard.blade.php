...
@section('tittle')
    <title>Admin | Scrum Board</title>
@endsection

@section('main-content')
    <main class="h-full">
        <div class="page-container relative h-full flex flex-auto flex-col">
            <div class="pt-8 pb-4 border-b border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-800">
                <div class="container mx-auto px-6">
                    <div class="flex justify-between items-end mb-6">
                        ...
                        <div class="avatar-group avatar-group-chained">
                            <span class="avatar avatar-circle avatar-sm cursor-pointer" data-avatar-size="30"
                            ...
                            <span class="avatar avatar-circle avatar-sm cursor-pointer" data-avatar-size="30"
                                data-bs-toggle="tooltip" data-bs-title="Terrance Monero">
                            ...
                            <span class="avatar avatar-circle avatar-sm cursor-pointer items-center" data-avatar-size="30"
                    ...
                    <div class="flex flex-col lg:flex-row justify-between lg:items-center gap-4">
                        <div role="tablist" class="tab-list tab-list-pill">
                            <button class="tab-nav tab-nav-pill active" role="tab" aria-selected="true" tabindex="0">
                                All
                            </button>
                            <button class="tab-nav tab-nav-pill" role="tab" aria-selected="false" tabindex="0">
                                Task
                            </button>
                            <button class="tab-nav tab-nav-pill" role="tab" aria-selected="false" tabindex="0">
                                Bug
            ...
            <div class="container mx-auto h-full">
                <div class="scrumboard flex flex-col flex-auto w-full h-full mb-2">
                    <div class="scrumboard-body flex max-w-full overflow-x-auto h-full mt-4 gap-4">
                        <div class="board-column flex flex-col mb-3 min-w-[300px] w-[300px]  max-w-[300px] p-0 rounded-lg">
                            ...
                            <div id="task-column-body">
                                <div
                                    ...
                                    <div class="card-body p-4">
                                        ...
                                        <span class="flex items-center gap-2 mb-2 text-sm font-semibold">
                                            <svg stroke="currentColor" fill="currentColor" stroke-width="0"
                                                viewBox="0 0 20 20" aria-hidden="true" class="text-lg" height="1em"
                                ...
                                <div
                                    ...
                                    <div class="card-body p-4">
                                        <div class="tag mr-2 rtl:ml-2 mb-2">
                                            <span class="tag-affix tag-prefix bg-indigo-500"></span>Low priority
                                        </div>
                        ...
                        <div class="board-column flex flex-col mb-3 min-w-[300px] w-[300px]  max-w-[300px] p-0 rounded-lg">
                            <div class="board-title px-4 py-3 flex justify-between items-center relative">
                                <h6>In progress</h6>
                                <ul class="dropdown-menu">
                                    <li class="menu-item menu-item-hoverable">
                                        <span class="text-lg">
...
@section('customJs')
    ...
    <!-- Page js -->
    <script src="js/pages/scrum-board.js"></script>
@endsection
