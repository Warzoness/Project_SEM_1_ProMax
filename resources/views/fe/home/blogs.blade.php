                                ...
                                <div class="content">
                                    ...
                                    <div class="axil-post-meta">
                                        <div class="post-author-avatar">
                                            <img src="{{ asset('assets') }}/fe/images/blog/author-image-2.png"
                                                alt="Author Images">
                                        </div>
                            ...
                            <div class="inner">
                                <div class="thumbnail">
                                    <a href="blog-details.html">
                                        <img src="{{ asset('assets') }}/fe/images/blog/blog-01.png" alt="Blog Images">
                                    </a>
                                </div>
                                <div class="content">
                                    ...
                                    <div class="axil-post-meta">
                                        <div class="post-author-avatar">
                                            <img src="{{ asset('assets') }}/fe/images/blog/author-image-1.png"
                                                alt="Author Images">
                                        </div>
                                        <div class="post-meta-content">
                                            <h6 class="author-title">
                            ...
                            <div class="inner">
                                <div class="thumbnail">
                                    <a href="blog-video.html">
                                        <img src="{{ asset('assets') }}/fe/images/blog/blog-02.png" alt="Blog Images">
                                    </a>
                        ...
                        <div class="content-blog mt--60">
                            <div class="inner">
                                <div class="blog-gallery-activation axil-slick-arrow arrow-between-side">
                                    ...
                                    <div class="thumbnail">
                                        <a href="blog-gallery.html">
                                            <img src="{{ asset('assets') }}/fe/images/blog/blog-03.png" alt="Blog Images">
                                        </a>
                                    </div>
                                    <!-- End Single Thumb  -->
                                    <!-- Start Single Thumb  -->
                                ...
                                <div class="content">
                                    ...
                                    <div class="axil-post-meta">
                                        <div class="post-author-avatar">
                                            <img src="{{ asset('assets') }}/fe/images/blog/author-image-3.png"
                                                alt="Author Images">
                                        </div>
                                        <div class="post-meta-content">
                                            <h6 class="author-title">
                        ...
                        <aside class="axil-sidebar-area">
                            ...
                            <div class="axil-single-widget mt--40">
                                ...
                                <div class="content-blog post-list-view mb--20">
                                    <div class="thumbnail">
                                        <a href="blog-details.html">
                                            <img src="{{ asset('assets') }}/fe/images/blog/blog-04.png"
                                                alt="Blog Images">
                                        </a>
                                    </div>
                                    <div class="content">
                                ...
                                <div class="content-blog post-list-view mb--20">
                                    <div class="thumbnail">
                                        <a href="blog-details.html">
                                            <img src="{{ asset('assets') }}/fe/images/blog/blog-05.png"
                                                alt="Blog Images">
                                        </a>
                                    </div>
                                    <div class="content">
                                ...
                                <div class="content-blog post-list-view">
                                    <div class="thumbnail">
                                        <a href="blog-details.html">
                                            <img src="{{ asset('assets') }}/fe/images/blog/blog-06.png"
                                                alt="Blog Images">
                                        </a>
                                    </div>
                                    <div class="content">
                            ...
                            <div class="axil-single-widget mt--40">
                                ...
                                <ul class="product_list_widget recent-viewed-product">
                                    ...
                                    <li>
                                        <div class="thumbnail">
                                            <a href="blog-details.html">
                                                <img src="{{ asset('assets') }}/fe/images/product/product-12.jpg"
                                                    alt="Blog Images">
                                            </a>
                                        </div>
                                        <div class="content">
                                    ...
                                    <li>
                                        <div class="thumbnail">
                                            <a href="blog-details.html">
                                                <img src="{{ asset('assets') }}/fe/images/product/product-10.jpg"
                                                    alt="Blog Images">
                                            </a>
                                        </div>
                                        <div class="content">
                                    ...
                                    <li>
                                        <div class="thumbnail">
                                            <a href="blog-details.html">
                                                <img src="{{ asset('assets') }}/fe/images/product/product-11.jpg"
                                                    alt="Blog Images">
                                            </a>
                                        </div>
                                        <div class="content">
